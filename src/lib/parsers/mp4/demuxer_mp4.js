...
//https://github.com/w3c/webcodecs/blob/main/samples/video-decode-display/worker.js
...
export class MP4Demuxer {
    ...
    constructor(uri, {onConfig, onChunk, onFinish}) {
        ...
        this.#file.onError = error => console.log(error);
